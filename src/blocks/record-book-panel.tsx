/**
 * @file UI зачётной книжки (студент и родитель).
 */
...
import styles from '@/pages/record-book.module.css'
...
export function RecordBookPanel({
  ...
  return (
    <div className={styles.page}>
      ...
      {error ? <p className={styles.gosuslugiNote}>{error}</p> : null}
      ...
      {meta && (meta.specialty || meta.group || meta.recordBook) ? (
        <div className={styles.meta}>
          <div className={styles.metaMain}>
            ...
            {meta.specialization ? <p className={styles.metaMuted}>{meta.specialization}</p> : null}
