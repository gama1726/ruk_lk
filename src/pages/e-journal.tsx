...
import { Button, Drawer, NoData, ScreenHeader, Select, Loader } from '@/ui'
...
export function EJournal() {
  ...
  if (!preview) return <ComingSoon title="Электронный журнал" />
  return <EJournalContent />
}
