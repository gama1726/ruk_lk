...
@Entity
@Table(name = "outbound_service_load_stats")
public class OutboundServiceLoadStats {

    @Id
    @Column(length = 320)
    private String id;

    /** Имя сервиса: onec, schedule, unisender, max, … */
    @Column(nullable = false, length = 32)
    private String method;

    /** Операция: например GET /hs/student/profile */
    ...
    protected OutboundServiceLoadStats() {}

    public OutboundServiceLoadStats(String id, String method, String path) {
        this.id = id;
        this.method = method;
        this.path = path;
